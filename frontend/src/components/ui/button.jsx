...
>>>>>>> e17768b1f796c0c35dcd889004bc97173ab086fc
  {
    variants: {
      variant: {
        default:
<<<<<<< HEAD
          "bg-secondary text-secondary-foreground shadow-soft hover:bg-secondary/90 hover:shadow-soft-md",
        destructive:
          "bg-destructive text-destructive-foreground shadow-soft hover:bg-destructive/90",
        outline:
          "border border-border bg-card shadow-soft hover:bg-muted hover:border-secondary/50",
        secondary:
